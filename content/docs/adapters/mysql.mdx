...
<Callout type="info">
  This adapter is currently in development. Core authentication features are
  available, with RBAC and advanced features planned for future releases.
</Callout>
...
<Callout>
  For production deployments with high traffic, consider using MySQL connection
  poolers like ProxySQL for better resource management and load balancing.
</Callout>
