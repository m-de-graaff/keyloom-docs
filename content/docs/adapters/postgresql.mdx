...
<Callout type="info">
  This adapter is currently in development. Basic authentication features are
  available, with RBAC and advanced features coming soon.
</Callout>
...
<Callout>
  For production deployments, consider using connection poolers like PgBouncer
