...
<Callout>
The complete schema is available in the package at `@keyloom/adapter-drizzle/schema` and can be customized for your needs.
</Callout>
...
<Callout>
For more advanced configuration and troubleshooting, see the [Drizzle ORM documentation](https://orm.drizzle.team/).
</Callout>
