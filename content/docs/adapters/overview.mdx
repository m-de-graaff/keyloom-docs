...
<TypeTable
  type={{
    createUser: {
      ...
      type: "(data: { email?: string, name?: string }) => Promise<User>",
      parameters: [
        {
          name: "data",
          description: "User data object with optional email and name",
        },
      ],
    ...
    getUser: {
      ...
      parameters: [{ name: "id", description: "User ID" }],
      returns: "Promise<User | null>",
    },
    getUserByEmail: {
      description: "Get a user by their email address",
      type: "(email: string) => Promise<User | null>",
      parameters: [{ name: "email", description: "User email address" }],
      returns: "Promise<User | null>",
    },
    updateUser: {
      ...
      parameters: [
        ...
        { name: "data", description: "Partial user data to update" },
      ],
      returns: "Promise<User>",
    },
    linkAccount: {
      ...
      parameters: [
        ...
        { name: "account", description: "OAuth account data" },
      ],
    ...
    getAccountByProvider: {
      ...
      parameters: [
        { name: "provider", description: "OAuth provider name" },
        { name: "providerAccountId", description: "Provider account ID" },
      ],
    ...
    createSession: {
      ...
      parameters: [{ name: "session", description: "Session data" }],
    ...
    createVerificationToken: {
      ...
      parameters: [{ name: "token", description: "Verification token data" }],
      returns: "Promise<void>",
    },
    useVerificationToken: {
      ...
      parameters: [
        { name: "identifier", description: "Token identifier" },
    ...
    appendAudit: {
      ...
      parameters: [
        {
          name: "event",
          description: "Audit event with type, userId, orgId, and meta fields",
        },
      ],
      returns: "Promise<void>",
    },
