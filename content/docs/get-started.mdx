---
title: Get Started with Keyloom
...
import { CodeBlockTabs } from "fumadocs-ui/components/code-block-tabs";
...
<Callout type="warn">
The `AUTH_SECRET` must be a base64url-encoded 32-byte string. The CLI generates one for you, but you can create your own:
