...
<Tab value="pnpm">```bash title="pnpm" pnpm dlx keyloom init ```</Tab>

<Tab value="yarn">```bash title="yarn" yarn dlx keyloom init ```</Tab>
...
<Tab value="pnpm">
  ```bash title="pnpm" pnpm add @keyloom/core @keyloom/nextjs ```
</Tab>

<Tab value="yarn">
  ```bash title="yarn" yarn add @keyloom/core @keyloom/nextjs ```
</Tab>
...
<Tab value="pnpm">
  ```bash title="Adapters & Providers (example)" pnpm add
  @keyloom/adapter-prisma @keyloom/providers ```
</Tab>

<Tab value="yarn">
  ```bash title="Adapters & Providers (example)" yarn add
  @keyloom/adapter-prisma @keyloom/providers ```
</Tab>
