...
<Callout>
Discord requires HTTPS for production callback URLs. Make sure your production environment uses SSL certificates.
</Callout>
...
<Callout type="info">
OAuth tokens and bot tokens serve different purposes. OAuth tokens authenticate users, while bot tokens authenticate your application as a bot.
</Callout>
