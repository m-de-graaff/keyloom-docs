...
<Cards>
  <Card
    title="@keyloom/core"
    href="/docs/api/core"
    description="Core authentication logic and utilities"
  />
  <Card
    title="@keyloom/nextjs"
    href="/docs/api/nextjs"
    description="Next.js integration and middleware"
  />
  <Card
    title="@keyloom/server"
    href="/docs/api/server"
    description="Standalone server implementation"
  />
  <Card
    title="@keyloom/adapters"
    href="/docs/api/adapters"
    description="Database adapters (Prisma, Memory, etc.)"
  />
  <Card
    title="@keyloom/providers"
    href="/docs/api/providers"
    description="OAuth providers (GitHub, Google, Discord)"
  />
  <Card
    title="@keyloom/cli"
    href="/docs/api/cli"
...
- [Core Package API](/docs/api/core) - Detailed core package documentation
- [Next.js Integration](/docs/api/nextjs) - Next.js specific APIs
- [Database Adapters](/docs/api/adapters) - Adapter interfaces and implementations
- [OAuth Providers](/docs/api/providers) - Provider configurations and setup
