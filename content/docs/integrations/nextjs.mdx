...
<Callout>
AUTH_SECRET must be base64url (A–Z a–z 0–9 - _) and decode to at least 32 bytes. `keyloom doctor --fix` can generate it.
</Callout>
...
export default createAuthMiddleware({
  // Use a routes manifest for precise protection when your app grows
})
```
