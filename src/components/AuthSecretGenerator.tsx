...
export function AuthSecretGenerator() {
  ...
  return (
    <div className="p-6 bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-950 dark:to-blue-900 rounded-xl border border-blue-200 dark:border-blue-800 my-6">
      <h3 className="text-lg font-semibold text-blue-900 dark:text-blue-100 mb-4">
        🔐 AUTH_SECRET Generator
      </h3>
      <p className="text-blue-700 dark:text-blue-300 text-sm mb-4">
        Generate a cryptographically secure 32-byte base64url-encoded secret for your Keyloom configuration.
      </p>
        ...
        {secret && (
          <div className="space-y-3">
            ...
            <div className="text-xs text-blue-600 dark:text-blue-400 bg-blue-100 dark:bg-blue-900 rounded-lg p-3">
              <strong>Usage:</strong> Add this to your <code className="bg-blue-200 dark:bg-blue-800 px-1 rounded">.env.local</code> file:
              <br />
