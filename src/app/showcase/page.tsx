...
export const metadata: Metadata = {
  ...
  description: 'Discover amazing projects and applications built with Keyloom authentication framework.',
};
      ...
      <div className="rounded-lg border border-dashed border-fd-border/50 bg-fd-background/40 p-12">
        ...
        <div className="space-y-4">
          ...
          <ol className="text-sm text-fd-muted-foreground text-left space-y-2 max-w-md mx-auto">
            <li>1. Edit <code className="bg-fd-muted px-1 py-0.5 rounded text-xs">src/data/showcase.ts</code></li>
            <li>2. Add your project details to the <code className="bg-fd-muted px-1 py-0.5 rounded text-xs">showcaseItems</code> array</li>
            <li>3. Include name, description, URL, and optionally an image and tags</li>
          </ol>
        </div>
        <div className="mt-6">
          <Link
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-fd-muted-foreground">
              ...
              From startups to enterprise solutions, see how developers are using 
              Keyloom to build secure, scalable authentication systems.
            </p>
          </div>
        </div>
      </section>
