...
export const metadata: Metadata = {
  ...
  description: 'Meet the amazing sponsors and supporters who make Keyloom possible.',
};
...
function SponsorCard({ sponsor }: SponsorCardProps) {
  const tierColors = {
    platinum: 'border-slate-300 bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-800 dark:to-slate-900 dark:border-slate-600',
    ...
    silver: 'border-gray-300 bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-900 dark:border-gray-600',
    bronze: 'border-orange-300 bg-gradient-to-br from-orange-50 to-orange-100 dark:from-orange-900/20 dark:to-orange-800/20 dark:border-orange-600',
  };
  ...
  return (
    <div className={`group relative flex h-full flex-col rounded-lg p-6 shadow-sm transition-all hover:-translate-y-0.5 hover:shadow-md focus-within:ring-2 focus-within:ring-primary/50 ${cardClass}`}>
      <a 
        href={sponsor.url} 
        target="_blank" 
    ...
    <div className="mx-auto max-w-2xl text-center">
      <div className="rounded-lg border border-dashed border-fd-border/50 bg-fd-background/40 p-12">
        ...
        <p className="text-fd-muted-foreground mb-6">
          Keyloom is an open source project that relies on the support of sponsors 
          and contributors to continue development and maintenance.
        </p>
        <div className="space-y-4">
          ...
          <ol className="text-sm text-fd-muted-foreground text-left space-y-2 max-w-md mx-auto">
            <li>1. Edit <code className="bg-fd-muted px-1 py-0.5 rounded text-xs">src/data/sponsors.ts</code></li>
            <li>2. Add sponsor details to the <code className="bg-fd-muted px-1 py-0.5 rounded text-xs">sponsors</code> array</li>
            <li>3. Include name, description, URL, and optionally a logo and tier</li>
          </ol>
        </div>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-fd-muted-foreground">
              ...
              Their contributions help us maintain and improve the framework for 
